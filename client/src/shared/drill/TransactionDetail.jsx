...
/**
 * TRANZAKSIYA TANASI — panelsiz.
 *
 * Ilgari bu JSX `FinancialTransactionDrawer` ichida, `Sheet` bilan
 * BIRIKKAN holda edi. Ajratildi, chunki universal drill paneli (shared/drill)
 * zanjirning oxirgi bo'g'inini O'Z panelida ko'rsatishi kerak — ikkita
 * ustma-ust `Sheet` ochilsa fokus tuzog'i (focus trap) buziladi va
 * "orqaga" tugmasi ishlamay qoladi.
 *
 * Nusxa YARATILMADI: eski panel endi shu komponentni o'raydi, ya'ni
 * moliya sahifasi va drill paneli AYNAN bir xil ko'rinishni ko'rsatadi.
 */
