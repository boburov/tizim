// ⚠ `server/src/modules/staffPayroll/validators/staffPayroll.validator.js`
// DAN AYNAN KO'CHIRILGAN.
import { z } from 'zod';
import {
  STAFF_SALARY_TYPES,
  KPI_TRIGGERS,
  KPI_REWARD_TYPES,
  STAFF_ADJUSTMENT_KINDS,
} from '../../common/constants/staff-payroll.js';

// Modul bo'yicha yagona pul turi (o'qituvchi validatoridagi bilan bir
// xil chegara — ikki modulda ikki xil limit bo'lib qolmasin).
...
export type EmployeeParamRequest = z.infer<typeof employeeParamSchema>;
...
export type CompensationPatchRequest = z.infer<typeof compensationPatchSchema>;
export type AdjustmentCreateRequest = z.infer<typeof adjustmentCreateSchema>;
export type RuleCreateRequest = z.infer<typeof ruleCreateSchema>;
export type RuleUpdateRequest = z.infer<typeof ruleUpdateSchema>;
export type RuleListRequest = z.infer<typeof ruleListSchema>;
export type AssignmentSetRequest = z.infer<typeof assignmentSetSchema>;
export type GenerateRangeRequest = z.infer<typeof generateRangeSchema>;
export type RecalcUnlockedRequest = z.infer<typeof recalcUnlockedSchema>;
export type PayrollStartRequest = z.infer<typeof payrollStartSchema>;
