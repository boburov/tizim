...
const K = (domain, subject, stance, tier) => ({ domain, subject, stance, tier });

export const INSIGHT_KIND_META = Object.freeze({
  // --- O'QUVCHILAR ---
...
export const isOpportunity = (kind) => INSIGHT_KIND_META[kind]?.stance === "opportunity";
