...
# generatsiya qilgan tiplarni import qiladi.
#
...
cd "$APP_DIR/server"
# NestJS entrypoint. (Eski Express `src/index.js` o'chirilgan — u yerda
# endi faqat main.ts bor, ya'ni eski yo'l har doim yiqilardi.)
