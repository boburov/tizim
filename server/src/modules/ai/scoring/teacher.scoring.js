...
const liftToScore = (lift, fullLift) => {
 ...
 */
export const scoreTeacher = (signals) => {
  ...
  const score = active.reduce((a, d) => a + d.score * d.weight, 0) / weightSum;
 ...
 */
export const qualifiesForRaise = ({ score, confidence, measured }, baseline, position) => {
