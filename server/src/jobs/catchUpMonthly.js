...
export const catchUpMonthlyGeneration = async () => {
  ...
  try {
    ...
    // DIQQAT: bu yerda "TeacherSalary.exists(oy)" bilan erta chiqib ketmaymiz.
    // O'qituvchi oy o'rtasida guruhga biriktirilsa BITTA maosh yozuvi yaratiladi;
    // global exists tekshiruvi shu bitta yozuvni ko'rib, oyning boshida generatsiya
    // o'tkazib yuborilgan BOSHQA barcha guruhlarni generatsiya qilmay qolardi.
    // generateMonth idempotent (mavjud yozuvlarni o'tkazib yuboradi) va regenerate
    // faqat HAQIQATAN yangi yozuv yaratilganda bildirishnoma yuboradi - shuning uchun
    // shartsiz chaqirish xavfsiz va yetishmayotgan yozuvlarni to'ldiradi.
