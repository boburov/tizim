// ⚠ `server/src/constants/approvals.js` DAN AYNAN KO'CHIRILGAN.
...
export const ALL_APPROVAL_STATUSES: string[] = Object.values(APPROVAL_STATUSES);
...
export const ALL_APPROVAL_CATEGORIES: string[] = Object.values(APPROVAL_CATEGORIES);
...
export const ALL_APPROVAL_KINDS: string[] = Object.values(APPROVAL_KINDS);
...
export const resolveCategory = (kind: string): string => {
...
export const ALL_EXPENSE_KINDS: string[] = ALL_APPROVAL_KINDS;
